...
const CreateBoardComponent = dynamic(() => import('./CreateBoardComponent'));
const SearchInput = dynamic(() => import('./SearchInput'));
const DashboardStats = dynamic(() => import('./DashboardStats'));
const ChangeViewButtons = dynamic(
  () => import('@/components/ChangeViewButtons'),
);
const BoardsComponent = dynamic(() => import('@/components/BoardsComponent'));
